...
export default function HeroSection() {
  ...
  return (
    <div className="relative h-[850px] md:h-screen lg:h-[774px] max-w-[1920px] overflow-hidden">
      <AnimatePresence>
      ...
      <div className="relative z-10 flex flex-col justify-center items-start h-full w-full px-6 sm:px-10 md:px-24 text-white">
        <h1 className="text-[40px] -mt-20 md:mt-0 w-[330px] md:text-[72px] md:w-full font-normal md:leading-[85px] tracking-[0.02em]">
          Pioneering Progress with <br /> Quality & Expertise
        </h1>
        <p className="mt-[25px] max-w-5xl text-[20px] md:text-[23px] font-light leading-[35px]">
      ...
      {/* STATS */}
      <div className="absolute bottom-0 left-0 w-full px-6 md:px-24 lg:pr-48">
        <div className="grid grid-cols-2 lg:grid-cols-4 text-white border-t-1">
          {/* Stat 1 */}
          <div className="flex flex-col border-l border-r border-[#C2C2C2] pl-[25px] lg:pl-[45px] text-left justify-center pb-5">
            <span className="text-[30px] lg:text-[68px] font-normal">35+</span>
          ...
          {/* Stat 2 - highlighted */}
          <div className="flex flex-col bg-[#FA3D2F] text-white pl-[25px] lg:pl-[45px] text-left justify-center pb-5">
            <span className="text-[30px] lg:text-[68px] font-normal">180M</span>
            <span className="text-[12px] lg:text-[19px] font-light">
              PORTFOLIO VALUE
            </span>
          </div>
          ...
          {/* Stat 3 */}
          <div className="flex flex-col border-x border-y border-[#C2C2C2] pl-[25px] lg:pl-[45px] text-left justify-center pb-5">
            <span className="text-[30px] lg:text-[68px] font-normal">750+</span>
            <span className="text-[12px] lg:text-[19px] font-light">
              PROJECTS COMPLETED
            </span>
          </div>
