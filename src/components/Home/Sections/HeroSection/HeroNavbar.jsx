...
export default function HeroNavbar() {
  ...
  return (
    <div className="absolute top-0 left-0 w-full z-20 h-[79px] md:h-[99px] lg:overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between h-full border-b border-[#DBDBDB] px-6 lg:px-0 lg:pl-24">
        {/* Logo */}
        ...
        <div className="hidden lg:flex items-center gap-10 h-full">
          <div className="flex flex-col items-end gap-5">
            ...
            {/* Nav Links */}
            <nav className="flex gap-[37px] text-white text-[16px] font-normal uppercase leading-[29px]">
          ...
          {/* Contact Button */}
          <div className="bg-[#EE3524] h-full flex px-[40px] py-[29px] items-center">
            <button className="text-white uppercase text-[16px] font-light border border-white rounded-[25px] py-[5px] px-[25px]">
              CONTACT
            </button>
          </div>
        </div>
