...
export default function AboutCompany() {
  return (
    <section> 
      <div className="w-full py-[50px] lg:py-[100px] container flex flex-col lg:flex-row justify-between overflow-hidden bg-white">
        {/* Left (Image) */}
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative lg:w-[705px] lg:h-[432px] lg:basis-[45%]"
        >
          <Image
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="w-full lg:basis-[55%] lg:ml-12 flex flex-col mt-6 lg:mt-0 lg:gap-6"
        >
          <p className="text-gray-800 text-[22px] lg:text-[32px] leading-[47px] font-light">
            GCC,{" "}
