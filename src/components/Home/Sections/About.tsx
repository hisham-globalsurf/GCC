...
export default function AboutCompany() {
  return (
    <div className="w-full py-16 px-6 sm:px-10 md:px-24 flex flex-col md:flex-row justify-between overflow-hidden bg-white">
      {/* Left (Image)F */}
      ...
      <div className="w-full md:basis-[55%] py-4 md:py-0 md:ml-12 flex flex-col gap-6">
        <p className="text-gray-800 text-[25px] md:text-[32px] leading-[47px] font-light">
          GCC,{" "}
